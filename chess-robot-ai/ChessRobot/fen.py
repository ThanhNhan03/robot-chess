...
class FEN():
    def __init__(self, id):
        ...
        self.id = id
        if self.id == 1:  # Dạng chuẩn Human cầm White đi trước
            self.FEN_last = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w - - 0 1"
            self.side = "b"
        elif self.id == 2:  # Human cầm White đi sau
            self.FEN_last = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR b - - 0 1"
            self.side = "w"
        elif self.id == 3:  # Human cầm Black đi sau
            self.FEN_last = "RNBQKBNR/PPPPPPPP/8/8/8/8/pppppppp/rnbqkbnr w - - 0 1"
            self.side = "b"
        elif self.id == 4:  # Human cầm Black đi trước
            self.FEN_last = "RNBQKBNR/PPPPPPPP/8/8/8/8/pppppppp/rnbqkbnr b - - 0 1"
            self.side = "w"
